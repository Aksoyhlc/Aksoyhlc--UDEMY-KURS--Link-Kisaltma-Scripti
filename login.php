                ...
                <div class="p-5">
                  ...
                  <form action="islemler/ajax.php" method="POST">
                    <div class="form-group">
                      <input type="email" name="kul_mail" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="E-Mail Adresiniz">
                    </div>
                    <div class="form-group">
                      <input type="password" name="kul_sifre" class="form-control form-control-user" id="exampleInputPassword" placeholder="Şifreniz">
                    </div>
                    <div class="mb-3">
                      <span class="text-primary"><a href="sifresifirla.php">Şifrenizi Mi Unuttunuz?</a></span>
                    </div>
...
if (@$_GET['durum']=="sifredegisti") { ?>
  <script type="text/javascript">
    Swal.fire({
      ...
      text: 'Şifreniz Başaıyla Değiştirildi Yeni Şifreniz İle Oturm Açın',
      confirmButtonText: "Tamam"
    })
  </script>
  <?php } ?>